...
group_G = [("brazil", "serbia"),("brazil", 'switzerland'),('brazil', 'cameroon'),('serbia', "switzerland"),('serbia', "cameroon"),("switzerland", "cameroon")]

run_group_matches(group_G, 'group_G', field)