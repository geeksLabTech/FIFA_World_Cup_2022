...
group_H = [("portugal", "ghana"),('portugal', 'uruguay'),('portugal', 'south-korea'),('ghana', "uruguay"),('ghana', "south-korea"),("uruguay", "south-korea")]

run_group_matches(group_H, 'group_H', field)